...
EOH;
		...
		*/
		...
		function writeTitleLine($line_arr) 
		{
		if($this->state!="OPENED")
			{
				$this->error="Error : Please open the file.";
			...
			fwrite($this->fp,"<tr>");
			foreach($line_arr as $col)
				fwrite($this->fp,"<td class=columnnames width=64 >$col</td>");
			fwrite($this->fp,"</tr>");
		}
		...
		*/
		...
		if($this->state!="OPENED")
			...
			fwrite($this->fp,"<td class=lefttitling width=24>$value</td>");
		}
	}
?>