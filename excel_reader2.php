...
////////////////////////////////////////////////////////////////////////////////////////
//added 06.06.2009 - dump everything to an array
	function dump_array($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') {
		$out_array = array();
		...
		for($row = 1; $row <= $this->rowcount($sheet); $row++) {
			...
			for($col = 1; $col <= $this->colcount($sheet); $col++) {
					$val = $this->val($row, $col, $sheet);
					$out_array[$row][$this->colindexes[$col]] = $val;
					}
				}
...
////////////////////////////////////////////////////////////////////////////////////////
//added 06.06.2009 - dump everything to a disk file
	function dump_file($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') {

		}

////////////////////////////////////////////////////////////////////////////////////////
//added 06.06.2009 - dump to csv file
